...
angular.
	...
	component('phoneList', {
	  ...
	  controller: ['$http', '$cookies', 'SelectedItems', function PhoneListController($http, $cookies, SelectedItems) {
	    const listPhonesUrl = '/phones/list';
	    ...
	    // $cookies	
	    var complexUser = new Object();
	    complexUser.userId = self.currentUser;
	    complexUser.name = "Bob";
	    
        var expirationDate = new Date();
        expirationDate.setDate(expirationDate.getDate() + 7);
        $cookies.putObject('currentUser', complexUser, {
