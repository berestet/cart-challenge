...
public class PhoneControllerTests {
     ...
     * @throws Exception
     */
    public void aPopulatePhoneRepositoryTest() throws Exception {
    ...
    @Test
    /**
     * Testing that POST /phones/order for userId "test123" for 2 phones:
     * [{id: "motorola-xoom-with-wi-fi", quantity: "2"}, {id: "dell-streak-7", quantity: "1"}]
     * 
     * successfully adds an order to the "order" collection.
     * 
     * TODO: ensure that quantity of the above phones have decreased accordingly in "phone" colleciton.
     * 
     * @throws Exception
     */
